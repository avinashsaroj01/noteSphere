...
function Navbar() {
    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-light fixied-top ">
            <div className="container-fluid">
            <div>
                
                <img style={{'width':'150px', 'height': 'auto'}} src={logo} alt="" />
                </div>
                ...
                <div className="collapse navbar-collapse" id="navbarNav">
                    <ul className="navbar-nav ms-auto">
                        ...
                        <li className="nav-item">
                            <Button className="nav-link" aria-current="page" component={NavLink} to="/aboutUs" variant="text" color="secondary" style={{ textTransform: "none", fontFamily: "'Poppins', sans-serif", fontSize: "0.9rem" }}>
                                About us
                            </Button>
                        </li>
                        {
