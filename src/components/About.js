            ...
            <div className="container mt-5 ">
                <div className="row">
                    <div className="col-md-6 d-flex flex-column justify-content-center">
                        ...
                        <p>MasterDsa is made helped Millions of Students to get trained and get placed into Multi-national Sofware Companies in a better position So we mad an online web platform where you can create, edit, upload, delete your notes/information privately and securely without any disturbancee.
                ...
                <div className="row login mt-5 mb-5 p-5">
                    ...
                    <div className="col-md-6 d-flex flex-column justify-content-center">
                        <h2 className="mb-3" style={{ fontWeight: "Bold" }}>Power your Code with <span style={{ color: "#9C27B0" }}>MasterDSA</span> </h2>
                        <p>
                            SignUP to enter in the world of MasterDSA and make it yours .
                        </p>
                        <div className="d-flex justify-content-center mt-3">
                ...
                <div className="content">
                    <div className="top">
                        <div className="logo-details">
                            <span className="logo_name"><span style={{ color: "#9C27B0" }}>Master</span>DSA</span>
                        </div>
                    ...
                    <div className="link-boxes">
                        ...
                        <ul className="box input-box">
                            <li className="link_name">About MasterDsa</li>
